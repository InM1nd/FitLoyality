    ...
    <>
      <Card className="flex h-full flex-col">
        <CardHeader className="flex-row items-center justify-between border-b border-border">
          ...
          <span className="rounded-full bg-[var(--info-bg)] px-2.5 py-0.5 text-[11px] font-semibold text-info">
            inactive 14+ days
          </span>
        </CardHeader>
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="truncate text-[11px] text-faint">
                    Last visit · {m.lastVisit} · {m.workoutsThisMonth} wo/mo
                  </p>
                </div>
                <Badge
                  variant={m.status === "churned" ? "error" : "warning"}
